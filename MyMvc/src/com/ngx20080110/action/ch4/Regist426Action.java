...
public class Regist426Action extends ActionSupport {
	private String name;
	private String pass;
	private int age;
	private Date birth;
	...
	public void validate() {
		System.out.println("in validate name=" + name);
		if (!name.contains("wugy")) {
			addFieldError("user", getText("user.contain"));
		}
	}
}
